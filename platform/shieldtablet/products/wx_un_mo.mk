...
PRODUCT_PROPERTY_OVERRIDES += ril.icera-config-args=notifier:ON,datastall:ON,lwaactivate
PRODUCT_PROPERTY_OVERRIDES += ro.modem.vc=1

DEVICE_PACKAGE_OVERLAYS := \
    $(LOCAL_PATH)/../../../product/phone/overlay-phone/$(PLATFORM_VERSION_LETTER_CODE) \
    $(DEVICE_PACKAGE_OVERLAYS)
